...
export function makeBinaryTransform(target: "File" | "Blob" = "File") {
  ...
  return function transform(schema: any): ts.TypeNode | undefined {
    ...
    if (isBinaryArray(schema)) {
      ...
      return schema.nullable
        ? ts.factory.createUnionTypeNode([ARR, NULL])
        : ARR;
    }
