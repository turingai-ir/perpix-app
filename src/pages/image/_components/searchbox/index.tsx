...
import { imagePageState } from '../../_state';
...
const SearchBox: FC<SearchBoxProps> = ({ onFinish, loading, error }) => {
  ...
  const [, setState] = useAtom(imagePageState);
          ...
          <form onSubmit={form.handleSubmit(handleSubmit)}>
            <Flex direction="column" gap="md">
              <TextAreaInput
                ...
                label={t('pages.image.searchBox.form.input.label')}
                name="input"
                ...
                textAreaProps={{
                  ...
                  minRows: 1,
                  maxRows: 4,
                  placeholder: t('pages.image.searchBox.form.input.placeholder'),
                  classNames: {
                    input:
